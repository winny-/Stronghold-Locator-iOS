...
- (void)locate {
    ...
    location1 = [StrongholdUtility parseSVectorFromTextField:self.location1TextField withF:YES];
    location2 = [StrongholdUtility parseSVectorFromTextField:self.location2TextField withF:YES];
